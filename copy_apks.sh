...
#cp /d/androidWorkspace/NfcApp/app/build/outputs/apk/debug/com.zoranl.nfcapp-v1\(0.1b\)-debug.apk   /d/mygit/MySharedApk/
...
FILE_DESTINATION=/d/mygit/MySharedApk/com.zoranl.nfcapp-v1\(0.1b\)-debug.apk
